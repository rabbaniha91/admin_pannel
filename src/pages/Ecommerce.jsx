  ...
  return (
    <div className=" mt-12">
      <div className=" flex flex-col justify-center items-center">
        <div
          className=" bg-white dark:text-gray-200 dark:bg-secondary-dark-bg min-w-[320px]
         h-44 xl:h-64 rounded-lg w-[95%] xs:w-[80%] p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-left"
        >
          <div className=" flex justify-between items-center">
            <div>
              <p className=" font-bold text-slate-700">درآمدها</p>
              <p className=" text-xl text-slate-600">102,000,000 $</p>
            </div>
          </div>
        ...
        <div className=" flex m-3 flex-wrap justify-center gap-2 items-center">
          {earningData.map((item) => (
            <div
              className=" bg-white dark:bg-secondary-dark-bg min-w-[180px] md:w-56 p-4 pt-9 w-full
             xs:max-w-[220px] rounded-2xl flex flex-col items-center"
            >
              <button
                type="button"
      ...
      <div className=" flex gap-10 flex-wrap justify-center">
        <div className=" bg-white dark:bg-secondary-dark-bg dark:text-gray-200 m-3 p-4 rounded-2xl">
          <div className=" flex justify-between">
            ...
            <div className=" flex items-center gap-4">
              ...
              >
                ...
                <span className=" texsm dark:text-white">هزینه ها</span>
              </p>
              <p
                className=" flex items-center gap-2 text-green-400 hover:drop-shadow-xl
              cursor-pointer"
              >
                <span>
                  <GoDotFill />
          ...
          <div className=" mt-10 flex flex-row-reverse gap-10 flex-wrap justify-center ">
            <div className=" border-r-1 dark:border-white border-color m-4 pr-10">
              <div>
                ...
                <p className=" mt-1">
                  ...
                  <span
                    className=" p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400
                 ml-3 text-xs"
                  >
                    45%
                  </span>
