...
export const kanbanGrid = [
  { headerText: "لیست کارها ", keyField: "Open", allowToggle: true },

  { headerText: "در حال انجام", keyField: "InProgress", allowToggle: true },
...
const customerGridStatus = (props) => (
  <div className="flex gap-2 justify-start items-center text-gray-700 capitalize">
    ...
    />
    <p
      className="dark:text-gray-50 opacity-80"
      style={{ color: props.StatusBg }}
    >
      {props.Status}
    </p>
  </div>
...
export const ColorMappingPrimaryYAxis = {
  ...
  minorTickLines: { width: 0 },
  labelFormat: "{value}°C",
  title: "دما بر حسب درجه سانتیگراد",
};
...
export const employeesGrid = [
  ...
  {
    field: "ReportsTo",
    headerText: "مسئول مستقیم",
    width: "120",
    textAlign: "Center",
  },
  {
    field: "EmployeeID",
    headerText: "شماره کارمندی",
    width: "125",
    textAlign: "Center",
  },
];
...
export const chatData = [
  {
    image: avatar2,
    message: "مونا به تیم پیوست",
    desc: "بهش تبریک می گم",
    time: "9:08 AM",
  },
  {
    image: avatar3,
    message: "دریافت پیام جدید",
    desc: "صدرا یک پیام جدید فرستاده",
    time: "11:56 AM",
  },
  {
    image: avatar4,
    message: "صورتحساب جدید صادر شد",
    desc: "صندوق دریافتی ها را چک کنید",
    time: "4:39 AM",
  },
  {
    image: avatar,
    message: "صدار کارهای خودش را به پایان رساند",
    desc: "بهش یک کار جدید محول کنید",
    time: "1:12 AM",
  },
];
...
export const userProfileData = [
  ...
  },
  {
    icon: <FiCreditCard />,
    title: "کارهای من",
    desc: "وظایف روزانه و برنامه ریزی شده",
    iconColor: "rgb(255, 244, 229)",
    iconBg: "rgb(254, 201, 15)",
  },
];
...
export const customersData = [
  {
    CustomerID: 1001,
    CustomerName: "ندا یاسی",
    CustomerEmail: "neda@gmail.com",
  ...
  },
  {
    ...
    CustomerName: "سامان برزو",
    CustomerEmail: "saman@gmail.com",
    ProjectName: "طراحی بنر",
    Status: "فعال",
  ...
  },
  {
    ...
    CustomerName: "اکبر ندائی",
    CustomerEmail: "akbar@gmail.com",
    ProjectName: "ساختمان",
    Status: "در انتظار",
  ...
  },
  {
    ...
    CustomerName: "میلادی خدائی",
    CustomerEmail: "milad@gmail.com",
    ProjectName: "ساخت دارو",
    Status: "تکمیل",
  ...
  },
  {
    ...
    CustomerName: "مهتاب کرمی",
    CustomerEmail: "mahtab@gmail.com",
    ProjectName: "ایجاد پنل ادمین",
    Status: "انصراف",
    CustomerImage: avatar2,
    StatusBg: "red",
    Weeks: "34",
...
export const ordersData = [
  ...
  {
    OrderID: 893486,
    CustomerName: "آتیلا پناهی",
    TotalAmount: 93.31,
    OrderItems: "کفش اسپورت",
    Location: "رشت",
    Status: "انصراف",
    StatusBg: "#FF5C8E",
  ...
  {
    OrderID: 748975,
    CustomerName: "دیانا بهرو",
    TotalAmount: 23.99,
    OrderItems: "ماشین اسباب‌بازی",
    Location: "مازندران",
    Status: "رد شد",
    StatusBg: "red",
  ...
  {
    OrderID: 94757,
    CustomerName: "یونس رهام",
    TotalAmount: 95.99,
    OrderItems: "عینک دودی",
    Location: "تهران",
    Status: "انصراف",
    StatusBg: "#FF5C8E",
  ...
  {
    OrderID: 874534,
    CustomerName: "نیما مرزبان",
    TotalAmount: 122.99,
    OrderItems: "ساعت هوشمند",
    Location: "آمل",
    Status: "انصراف",
    StatusBg: "#FF5C8E",
    ProductImage:
  ...
  {
    OrderID: 893486,
    CustomerName: "همایون رها",
    TotalAmount: 93.31,
    OrderItems: "کفش ورزشی",
    Location: "ارومیه",
    Status: "انصراف",
    StatusBg: "#FF5C8E",
    ProductImage: product4,
...
export const scheduleData = [
  {
    Id: 1,
    Subject: "جلسه با مدیر شرکت",
    Location: "سالن جلسات شرکت",
  ...
  {
    Id: 2,
    Subject: "تحویل پرژه مربوط به آزمایشگاه",
    Location: "آزمایشگاه گرانول",
    StartTime: "2023-10-16T06:30:00.000Z",
    EndTime: "2023-10-16T08:30:00.000Z",
...
export const pieChartData = [
  { x: "تهران", y: 18, text: "18%" },
  { x: "البرز", y: 8, text: "8%" },
  { x: "قزوین", y: 15, text: "15%" },
  { x: "مازندران", y: 11, text: "11%" },
  { x: "رشت", y: 18, text: "18%" },
  { x: "شیراز", y: 14, text: "14%" },
  { x: "خوزستان", y: 16, text: "16%" },
];
...
export const kanbanData = [
  {
    Id: "Task 1",
    Title: "کار شماره 3256",
    Status: "Open",
    Summary: "بررسی کردن نیازهای جدید مشتریان",
    Type: "Story",
    Priority: "Low",
  ...
  {
    Id: "Task 2",
    Title: "کار شماره 29002",
    Status: "InProgress",
    Summary: "بهبود کارآیی اپلیکیشن ها",
    Type: "Improvement",
    Priority: "Normal",
    Tags: "Improvement",
    Estimate: 6,
  ...
  {
    Id: "Task 3",
    Title: "کار شماره   29003",
    Status: "Open",
    Summary:
      "طرح ریزی برای ملاقات آنلاین با یکی از مشتریان برای بررسی نیازهای جدید",
    Type: "Others",
    Priority: "Critical",
    Tags: "Meeting",
    Estimate: 5.5,
  ...
  {
    Id: "Task 4",
    Title: "کار شماره 29004",
    Status: "InProgress",
    Summary: "رفع کردن خطای گزارش شده در مرورگر کروم",
    Type: "Bug",
    Priority: "Critical",
    Tags: "IE",
    Estimate: 2.5,
  ...
  {
    Id: "Task 5",
    Title: "کار شماره   29005",
    Status: "Review",
    Summary: "حل کردن مشکلات گزارش شده توسط مشتریان",
    Type: "Bug",
    Priority: "Low",
    Tags: "Customer",
    Estimate: "3.5",
  ...
  {
    Id: "Task 6",
    Title: "کار شماره   29007",
    Status: "Validate",
    Summary: "امکان سنجی نیازهای جدید",
    Type: "Improvement",
    Priority: "Low",
    Tags: "Validation",
    Estimate: 1.5,
  ...
  {
    Id: "Task 7",
    Title: "کار شماره   29009",
    Status: "Review",
    Summary: "بررسی کردن مشکلات رخ داده وب سایت در مرورگر سافاری",
    Type: "Bug",
    Priority: "Critical",
    Tags: "Fix,Safari",
    Estimate: 1.5,
  ...
  {
    Id: "Task 8",
    Title: "کار شماره  29010",
    Status: "Close",
    Summary: "تست کردن برنامه جدید در مرورگر کروم و فایرفاکس",
    Type: "Story",
    Priority: "Low",
    Tags: "Review,IE",
    Estimate: 5.5,
  ...
  {
    Id: "Task 9",
    Title: "کار شماره  29011",
    Status: "Validate",
    Summary: "مرتفع کردن خطای برنامه گزارش شده توسط مشتری",
    Type: "Story",
    Priority: "High",
    Tags: "Validation,Fix",
    Estimate: 1,
  ...
  {
    Id: "Task 10",
    Title: "کار شماره  29015",
    Status: "Open",
    Summary: "نمایش دادن اطلاعات دریافت شده از دیتابیس در گرید",
    Type: "Story",
    Priority: "High",
    Tags: "Database,SQL",
    Estimate: 5.5,
  ...
  {
    Id: "Task 11",
    Title: "کار شماره  29016",
    Status: "InProgress",
    Summary: "رفع خطای مربوط به دیتابیس",
    Priority: "Critical",
    Type: "Bug",
  ...
  {
    Id: "Task 12",
    Title: "کار شماره   29017",
    Status: "Review",
    Summary: "رفع خطای مربوط به همگام سازی داده ها",
    Type: "Story",
    Priority: "Normal",
    Tags: "Databinding",
    Estimate: "3.5",
  ...
  {
    Id: "Task 13",
    Title: "کار شماره  29018",
    Status: "Close",
    Summary: "بررسی صحت وصل بودن به دیتابیس شرکت",
    Type: "Story",
    Priority: "Critical",
    Tags: "Grid,Sql",
    Estimate: 2,
  ...
  {
    Id: "Task 14",
    Title: "کار شماره 29019",
    Status: "Validate",
    Summary: "قرار ملاقات با مدیر شرکت",
    Type: "Story",
    Priority: "Low",
    Tags: "Validation",
    Estimate: 1.5,
  ...
  {
    Id: "Task 15",
    Title: "کار شماره  29020",
    Status: "Close",
    Summary: "دیباگ کردن اپلیکیشن ",
    Type: "Story",
    Priority: "High",
    Tags: "Analyze",
    Estimate: 2.5,
  ...
  {
    Id: "Task 16",
    Title: "کار شماره  29021",
    Status: "Close",
    Summary: "تنظیم قراردادنامه با شرکت گرانول",
    Type: "Others",
    Priority: "Critical",
    Tags: "Databinding",
    Estimate: 1.5,
  ...
  {
    Id: "Task 17",
    Title: "کار شماره   29022",
    Status: "Close",
    Summary: "تست شبکه های داخلی و رفع خطا",
    Type: "Story",
    Priority: "Critical",
    Tags: "Procedures",
    Estimate: 5.5,
  ...
  {
    Id: "Task 18",
    Title: "کار شماره  29023",
    Status: "Validate",
    Summary: "تعویض لوازم از کار افتاده شبکه",
    Type: "Story",
    Priority: "Critical",
    Tags: "Editing",
    Estimate: 1,
  ...
  {
    Id: "Task 19",
    Title: "کار شماره  29024",
    Status: "Review",
    Summary: "تست شبکه بعد از اتمام تعمیر و تعویض قطعات",
    Type: "Story",
    Priority: "Normal",
    Tags: "Editing,Test",
    Estimate: 0.5,
  ...
  {
    Id: "Task 20",
    Title: "کار شماره  29025",
    Status: "Open",
    Summary: "ارتقا قدرت سخت افزاری کامپیوترهای کارشناسان",
    Type: "Improvement",
    Priority: "Low",
    Tags: "Editing",
    Estimate: 3.5,
  ...
  {
    Id: "Task 21",
    Title: "کار شماره  29026",
    Status: "InProgress",
    Summary: "برگزاری جلسه توجیهی کارکنان جدید",
    Type: "Epic",
    Priority: "High",
    Tags: "Performance",
    Estimate: 6,
  ...
  {
    Id: "Task 22",
    Title: "کار شماره  29027",
    Status: "Open",
    Summary: "انتقال دفتر مدیریت به ساختمان جدید",
    Type: "Others",
    Priority: "High",
  ...
  {
    Id: "Task 23",
    Title: "کار شماره  29029",
    Status: "Review",
    Summary: "پر کردن برگه های مالی و تحویل آن به اداره مالیات",
    Type: "Bug",
    Priority: "Low",
    Tags: "Editing,Fix",
    Estimate: "3.5",
...
export const PyramidData = [
  { x: "شیرینی", y: 120, text: "120 کالری" },
  { x: "شیر, ماست, پنیر", y: 435, text: "435 کالری" },
  { x: "سبزیجات", y: 470, text: "470 کالری" },
  { x: "گوشت, طیور , ماهی", y: 475, text: "475 کالری" },
  { x: "میوه‌جات", y: 520, text: "520 کالری" },
  { x: "نان, برنج", y: 930, text: "930 کالری" },
];
